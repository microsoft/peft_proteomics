...
def get_cosine_decay_schedule(optimizer, T_0 = 10, T_mult = 1, eta_min = 4e-6):
    return torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0, T_mult, eta_min)
